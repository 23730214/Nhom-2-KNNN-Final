...
def thong_bao(thong_diep, mau_sac):
    ...
    vi_tri_tin_nhan = tin_nhan.get_rect(center=(chieu_rong_cua_so / 2, chieu_cao_cua_so / 2))  # Đặt thông báo ở giữa màn hình
    cua_so.blit(tin_nhan, vi_tri_tin_nhan)  # Vẽ thông báo lên màn hình
 
while not tro_choi_bat_dau:
    cua_so.fill(xam)  # Điền nền bằng màu xám
    thong_bao("Nhấn một phím bất kỳ để bắt đầu", vang)  # Hiển thị thông báo chờ
